...
namespace Shard::System::Resource
{
    ...
    //GUID is the resource¡¯s file system path(stored either as a string
	...
	public:
		...
		virtual Utils::JobHandle AsyncResponseRequest(ResourceID resource_id) {}
	};
	...
	private:
		...
		std::atomic<JobHandle> async_load_worker_;
