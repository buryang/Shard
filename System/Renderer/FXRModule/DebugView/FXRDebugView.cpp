...
namespace Shard::Renderer::FXR
{
    ...
    void FXRDrawDebugView::Init()
    {
        DebugViewRender::Init();
    }

    void FXRDrawDebugView::Unit()
    {
        DebugViewRender::UnInit();
    }

    void FXRDrawDebugView::Draw(Render::RenderGraphBuilder& builder, System::DebugView::DebugViewSystem& debugview)
    {
