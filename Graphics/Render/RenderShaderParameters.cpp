...
namespace Shard::Render {
    ...
    RenderShaderParameterInfosMapUtils::RenderShaderParameterInfosMapUtils(RenderShaderParameterInfosMap& map):map_(map)
    {
    }
    
    bool RenderShaderParameterInfosMapUtils::FindShaderParameters(const String& name, ShaderParametersReflection& allocation)
    {
    ...
    void RenderShaderParameterInfosMapUtils::AddShaderParameters(const ShaderParametersReflection& allocation)
    {
    ...
    void RenderShaderParameterInfosMapUtils::RemoveShaderParameters(const String& name)
    {
        map_.erase(name);
    }
    
    const RenderShaderParameterInfosMapUtils::HashType& RenderShaderParameterInfosMapUtils::ComputeHash() const
    {
