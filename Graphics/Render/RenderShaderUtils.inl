...
private: static struct RenderShaderParametersMeta meta_info_; \
public:\
    struct RenderShaderParametersMeta& GetParameterMetaInfo()const\
    {\
        return meta_info_;\
    }\
private:\
...
public:\
    static bool operator(){\
        RenderShaderParametersMeta::Element el{ .type_  = Type, .name = MemberName, .byte_offset_ = 0u };\
