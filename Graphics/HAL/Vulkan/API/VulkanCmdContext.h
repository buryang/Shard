...
#include "HAL/Vulkan/HALSyncVulkan.h"
#include <mutex>
...
namespace Shard
{
    ...
    */
    class VulkanCmdPool : public VulkanDeviceObject
    {
    public:
        enum EState :uint8_t
        {
        ...
        void* GetHandle()override final { return handle_; }
    ...
    class VulkanBuffer;
    class VulkanImage;
    class VulkanCmdBuffer : public VulkanDeviceObject
    {
    public:
        ...
        FORCE_INLINE void* GetHandle() override final {
            return handle_;
        }
        ...
        void Barrier(const HAL::VulkanTransitionInfo& barrier_info);
    ...
    private:
        ...
        VkFence fence_{ VK_NULL_HANDLE }; //to host sync
        VkSemaphore semaphore_{ VK_NULL_HANDLE }; //to other queue sync
        VkFlags flags_{ 0 };
