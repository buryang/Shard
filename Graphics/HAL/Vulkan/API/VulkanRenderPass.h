...
namespace Shard
{
    void MakeRenderPassBeginInfo(VkRenderPassBeginInfo& pass_begin_info, VkRenderPass render_pass, VkFramebuffer frame_buffer, VkRect2D render_area, Span<VkClearValue> clear_values);
...
#undef RTACTION_MAKE_MASK
        ...
        static Ptr Create(VulkanDevice* device, const Desc& desc);
    ...
    private:
        void Init(VulkanDevice* device, const Desc& desc);
    private:
