...
namespace MetaInit::RHI {
	...
	public:
		...
		virtual void AddRHIShader(const RHIShaderInitializer& initializer) { LOG(ERROR) << "add shader from initializer not implement"; }
		virtual void AddRHIShader(RHIShader::Ptr shader) { LOG(ERROR) << "add raw shader not implemented"; };
